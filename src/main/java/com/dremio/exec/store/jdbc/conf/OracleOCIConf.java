...
@SourceType(value = "OracleOCIARP", label = "OracleOCI",uiConfig = "oracleoci-layout.json")
public class OracleOCIConf extends AbstractArpConf<OracleOCIConf> {
  private static final String ARP_FILENAME = "arp/implementation/oracleoci-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.oracleoci.OracleOCIDriver";
